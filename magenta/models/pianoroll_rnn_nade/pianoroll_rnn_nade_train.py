...
def main(unused_argv):
  ...
  build_graph = pianoroll_rnn_nade_graph.build_graph(
  ...
  if FLAGS.eval:
    ...
    events_rnn_train.run_eval(build_graph, train_dir, eval_dir, num_batches)

  else:
    events_rnn_train.run_training(build_graph, train_dir,
