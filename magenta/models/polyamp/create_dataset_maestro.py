...
from magenta.models.polyamp import audio_label_data_utils, create_dataset_lib, dataset_reader
...
absl.flags.DEFINE_boolean('preprocess_examples', False,
...
absl.flags.DEFINE_string('dataset_config', 'maestro',
