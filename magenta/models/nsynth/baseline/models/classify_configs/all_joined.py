...
"""Classify pitch, instrument (combined family and source), and qualities."""
...
def fit(x, hparams, is_training=True, reuse=False):
  ...
  with tf.variable_scope("encoder", reuse=reuse):
    ...
    total = (hparams.n_pitches + hparams.n_instrument_families +
             hparams.n_instrument_sources + hparams.n_qualities)
