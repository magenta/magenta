...
flags.DEFINE_float('alpha', 0.25, 'Number of Filters Multiplier for the transform model')
...
def main(unused_argv=None):
  ...
  with tf.Graph().as_default():
    ...
    with tf.device(tf.train.replica_device_setter(FLAGS.ps_tasks)):
      ...
      # Define the model
      stylized_images, total_loss, loss_dict, _ = build_mobilenet_model.build_mobilenet_model(
          content_inputs_,
          style_inputs_,
