...
def build_mobilenet_model(content_input_,
  ...
  Args:
    ...
    transformer_alpha: bool. Number of Filter multiplier to slim down the
        transformer model.
  ...
  [activation_names,
   activation_depths] = transformer_model.style_normalization_activations(alpha=transformer_alpha)
