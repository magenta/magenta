...
tf.app.flags.DEFINE_string('run_dir', '/tmp/events_rnn/logdir/run1',
...
def run_from_flags(config):
  """Run training or evaluation from flags and configuration.

  Args:
    config: An EventSequenceRnnConfig object.
  """
