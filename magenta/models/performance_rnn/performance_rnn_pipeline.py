...
import magenta
from magenta.music import sequences_lib, Performance, MetricPerformance
from magenta.music.performance_lib import NotePerformance, TooManyTimeShiftStepsError, \
