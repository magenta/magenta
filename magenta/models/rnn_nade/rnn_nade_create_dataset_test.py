...
"""Tests for rnn_nade_create_dataset."""
...
from magenta.models.rnn_nade import rnn_nade_create_dataset
...
class RnnNadePipelineTest(tf.test.TestCase):
  ...
  def testRnnNadePipeline(self):
    ...
    pipeline_inst = rnn_nade_create_dataset.get_pipeline(
