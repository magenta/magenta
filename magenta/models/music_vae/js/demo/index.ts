...
import { MusicVAE, Note, DrumsConverter, DrumRollConverter, MelodyConverter, INoteSequence} from '../index';
...
const DRUM_SEQS: INoteSequence[] = [
  {notes: [
    {pitch:36, quantized_start_step:0},
    {pitch:42, quantized_start_step:2},
    {pitch:36, quantized_start_step:4},
    {pitch:42, quantized_start_step:6},
    {pitch:36, quantized_start_step:8},
    {pitch:42, quantized_start_step:10},
    {pitch:36, quantized_start_step:12},
    {pitch:42, quantized_start_step:14},
    {pitch:36, quantized_start_step:16},
    {pitch:36, quantized_start_step:24},
    {pitch:36, quantized_start_step:28},
    {pitch:42, quantized_start_step:30}
  ]},
  {notes: [
