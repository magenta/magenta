...
parser.add_argument('--mode', dest='mode', default='move',
                    help='(move), copy, delete')
parser.add_argument('--path_in', dest='path_in', required=True,
...
parser.add_argument('--from', dest='from_', type=int, default=0,
                    help='from')
parser.add_argument('--to', dest='to_', type=int, default=0,
                    help='to')
