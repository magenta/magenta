...
parser.add_argument('--video_in', dest='video_in',
                    ...
                    required=True)
parser.add_argument('--from', dest='from_s', type=float, default=-1,
                    help='starting time in second (-1)')
parser.add_argument('--to', dest='to_s', type=float, default=-1,
...
parser.add_argument('--multiple', dest='multiple', type=int, default=10000,
                    help='if used with a wildcard (*), "multiple" will be added for each video (10000)')
parser.add_argument('--format', dest='format_ext', default='jpg',
                    help='(jpg) or png')
