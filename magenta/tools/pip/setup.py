...
CONSOLE_SCRIPTS = [
    ...
    'magenta.models.melody_rnn.polyphonic_rnn_create_dataset',
    'magenta.models.melody_rnn.polyphonic_rnn_generate',
    'magenta.models.melody_rnn.polyphonic_rnn_train',
