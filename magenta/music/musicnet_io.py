...
"""Import NoteSequences from MusicNet. This file is py2only compatible
because the original musicnet dataset was pickled using py2 and therefore
cannot be deserialized with py3.
"""
